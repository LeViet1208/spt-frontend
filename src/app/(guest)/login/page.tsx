...
export default function SignInPage() {
  ...
  const signInWithGoogle = async () => {
    try {
      ...
      // Update the Firebase user in the store
      ...
      // Store user info and ID token in session storage
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Sign in with backend using the Zustand store method
      ...
      setLocalError(error.message || "Unable to sign in with Google")
    } finally {
      setLoading(false)
    }
  }
